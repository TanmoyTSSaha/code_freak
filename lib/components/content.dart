class Content{
  ...
  Content({this.id = 0, this.title = "x", this.desc = "X", this.image = "x"});
}
...
List<Content> contents = [
  Content(
    ...
    desc: "C++ is a general purpose programming language and widely used now a days for competitive programming. It" 
    "has imperative, object-oriented and generic programming features. C++ runs on lots of platform like Windows, Linux," 
    "Unix, Mac etc.", 
    ...
    desc: "C++ is a general-purpose programming language that was developed as an enhancement of" 
    "the C language to include object-oriented paradigm. It is an imperative and a compiled language." 
    ...
    "scale applications can be built. Procedural code becomes difficult to maintain as code-size grows."
    ...
    "C++ is one of the predominant languages for the development of all kind of" 
    ...
    image: "https://media.geeksforgeeks.org/wp-content/cdn-uploads/20190430122723/cpp-program-compilation3-1024x375.png",
    ) 
];