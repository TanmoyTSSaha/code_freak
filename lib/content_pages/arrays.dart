...
import 'package:code_freak_2/quiz/array_quiz.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class Arrays extends StatelessWidget {
  const Arrays({Key? key}) : super(key: key);
        ...
        TextButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const ArrayQuiz(),
                ),
              );
            },
            child: const Text(
...
class ArraysContent extends StatelessWidget {
  const ArraysContent({Key? key}) : super(key: key);
