...
class BasicInputOutPut extends StatelessWidget {
  const BasicInputOutPut({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Container(
            ...
            color: Colors.white,
            child: const BasicInputOutPutContent(),
          ),
        ),
      ),
    );
...
class BasicInputOutPutContent extends StatelessWidget {
  const BasicInputOutPutContent({Key? key}) : super(key: key);
