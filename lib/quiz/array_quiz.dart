...
class ArrayQuiz extends StatelessWidget {
  const ArrayQuiz({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    ArrayQuestionController _questionController =
        Get.put(ArrayQuestionController());
    ArrayQuestionController _controller = Get.put(ArrayQuestionController());
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
            onPressed: () {
...
class QuestionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Container(
        margin: const EdgeInsets.all(kDefaultPadding), // this is the margin for quiz card.
...
class Option extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return GetBuilder<ArrayQuestionController>(
        init: ArrayQuestionController(),
...
class ProgressBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetBuilder<ArrayQuestionController>(
          init: ArrayQuestionController(),
          builder: (controller) {
            return Stack(
              children: [
